...
import Frontend_1 from '../../assets/frontend1.webp'
import Frontend_2 from '../../assets/frontend2.webp'
import Frontend_3 from '../../assets/frontend3.webp'

export default function Skills() {
    return (
        <div>
            <main id='skills' className='mt-4 py-6 px-4 sm:p-6 md:py-10 md:px-8'>
                <div className='max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2'>
                    ...
                    <h1 className='mt-1 text-lg font-semibold text-white sm:text-slate-900 md:text-3xl'>Front-end development</h1>
                    ...
                    <div data-aos='fade-up' data-aos-delay='300' className='grid gap-4 col-start-1 col-end-3 row-start-1 sm:mb-6 sm:grid-cols-4 lg:gap-6 lg:col-start-2 lg:row-end-6 lg:row-span-6 lg:mb-0'>
                        ...
                        <img src={Frontend_3} alt="" className='hidden w-full h-52 object-cover rounded-lg md:block lg:row-start-2 lg:col-span-2 lg:h-32 ' loading='lazy'/>
                    </div>
                    ...
                    <p data-aos='fade-up' data-aos-delay='600' className='mt-4 text-sm leading-6 col-start-1 sm:col-span-2 lg:mt-6 lg:row-start-4 text-blue-950 lg:col-span-1 '>
                        Frontend developer with expertise in HTML, CSS, JavaScript, Tailwind CSS, and React, dedicated to creating visually appealing, fast, and user-friendly websites.
                    </p>
                </div>
            </main>
        </div>
